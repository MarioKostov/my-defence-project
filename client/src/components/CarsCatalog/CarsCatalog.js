export const CarsCatalog = () => {
    ...
    return (
        <div className="grid" onSubmit={onSubmit}>
            <div className="row">
                        ...
                        <div className="txtcontent">
                            ...
                            <div className="simpletxt">
                                ...
                                <div className="wishtxt">
                                    <p className="paragraph1"> Add to Wishlist <span
                                        className="glyphicon glyphicon-heart"></span> </p>
                                    <p className="paragraph2">Compare <span className="icon"><img src="image/compicon.png"
                                        alt="compicon" /></span></p>
                                </div>
                            </div>
